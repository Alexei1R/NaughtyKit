...
extension mat4f {
    ...
    // NOTE: Component Getters/Setters
    ...
    public var rotation: vec3f {
        get {
            ...
            let _ = columns.2.x / scaleVec.z
            let _ = columns.2.y / scaleVec.z
    ...
    // NOTE: Matrix Composition/Decomposition
